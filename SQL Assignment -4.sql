...
insert into ord values(5,'1795/07/21',25.50,10) --can't be done as theere is a conflict between INSERT statement and  FOREIGN KEY constraint "FK__ord__Customer_id__37A5467C"
...
create table tblorder(Id int primary key,order_date date,order_number int,cust_id int,total_amount int)
